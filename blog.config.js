...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://everlovegames.cn', // 网站地址
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/384388508?spm_id_from=333.1007.0.0', // B站主页
