...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一位玩家🎮️, 也是一名策划🖊️, 欢迎来到曾經、の 游戏世界💻️',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '曾經、', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '在路上的系统策划🚘', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'everlovegames.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '游戏,曾經,策划', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '2079447256@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/384388508', // B站主页
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,email,twitter', // 分享的服務，按顺序显示,逗号隔开
